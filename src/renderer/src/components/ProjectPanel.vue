  ...
  <div>
    ...
    <div v-if="scanResult" class="results">
      ...
      <div class="view-toggle">
        <button @click="emit('update:view', 'language')" :class="['toggle-btn', { active: currentView === 'language' }]">
          <span>By Language</span>
        </button>
        <button @click="emit('update:view', 'type')" :class="['toggle-btn', { active: currentView === 'type' }]">
          <span>By Type</span>
        </button>
      </div>
      ...
      <div class="categories">
        <div v-for="category in projectCategories" :key="category" class="category-section">
          ...
          <div class="projects-grid">
            <div v-for="project in groupedProjects[category]" :key="project.path" class="project-card">
              ...
              <div class="card-actions">
                ...
                <button class="action-btn vscode" title="Open with VS Code" @click="emit('open-vscode', project)">
